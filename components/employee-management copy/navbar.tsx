          ...
          {showSearchBar && (
              <div className="hidden md:block flex-1 max-w-lg mx-8">
                <div className="relative">
                  ...
                  <Input
                    type="text"
                    placeholder="Cari Data Berdasarkan Nama, Jabatan, Unit Kerja"
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center space-x-2 px-3">
                  ...
                  <div className="hidden md:block text-left">
                    <p className="text-sm font-medium text-gray-900">{user.account_name}</p>
                    <p className="text-xs text-gray-500">{user.account_email}</p>
                  </div>
